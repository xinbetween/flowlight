...
struct AnomalySettings: Sendable {
    ...
    /// Keep Apple's own applications out of the Alerts list. On, because macOS is the noisiest thing on a Mac.
    var ignoreAppleApps = true
    ...
    enum Keys {
        ...
        static let ignoreAppleApps = "alerts.ignoreAppleApps"
    ...
    static func registerDefaults() {
        UserDefaults.standard.register(defaults: [
            ...
            Keys.notifications: true, Keys.retentionHours: 6.0, Keys.ignoreAppleApps: true,
    ...
    static var current: AnomalySettings {
        ...
        s.ignoreAppleApps = d.bool(forKey: Keys.ignoreAppleApps)
